...
## Prerequisites
1. **Redactor JS (version 3.\*.\*)**: (docs/redactor3/)

## Reproduction Steps
This vulnerability can be tested from the pre-configured CKEditor instance present [here](https://7ragnarok7.github.io/).
